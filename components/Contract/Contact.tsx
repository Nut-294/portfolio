...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="py-16 px-6 text-foreground relative bg-gray-50 dark:bg-gray-900"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {contactItems.map((item, index) => (
            ...
            >
              ...
              <p className="mt-2 font-mono text-green-700 dark:text-green-300">
                {item.value}
              </p>
            </a>
          ))}
